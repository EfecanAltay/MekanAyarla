...
router.patch('/:id/slots/:slotId/toggle', authenticate as any, authorize([UserRole.BUSINESS_ADMIN, UserRole.SUPER_ADMIN, UserRole.CUSTOMER]) as any, updateSlotStatus as any);
